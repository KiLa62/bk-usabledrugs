...
BK.allEffects.pink_visual = function(duration)
    local effectName = "visual_color"
    
    if(not BK.activeEffects[effectName]) then
        BK.activeEffects[effectName] = duration
        ...
        while timer <= BK.activeEffects[effectName] do
        ...
        BK.activeEffects[effectName] = false
    else
        BK.activeEffects[effectName] = BK.activeEffects[effectName] + duration
    end
end

BK.allEffects.visual_shaking = function(duration) 
...
BK.allEffects.drunk_walk = function(duration) 
...
BK.allEffects.green_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.confused_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.yellow_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.blurred_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.red_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.foggy_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.blue_visual = function(duration)
    local effectName = "visual_color"
...
BK.allEffects.armor50 = function()
    AddArmourToPed(PlayerPedId(), 50)
end

BK.allEffects.armor100 = function()
    AddArmourToPed(PlayerPedId(), 100)
end

BK.allEffects.health50 = function()
    local plyPed = PlayerPedId()
...
BK.allEffects.health100 = function()
    local plyPed = PlayerPedId()
...
BK.allEffects.sprint_faster = function(duration)
...
BK.allEffects.swim_faster = function(duration)
...
BK.allEffects.fall = function(duration)
...
BK.allEffects.infinite_stamina = function(duration)
...
BK.allEffects.remove_old_effects = function()
    for effectName, effectTime in pairs(BK.activeEffects) do
        if(effectTime) then
            BK.activeEffects[effectName] = 0
        end
    end
end

RegisterNetEvent('bk-usabledrugs:assumeDrug', function(type)
    local plyPed = PlayerPedId()
...
local function drugEffects(type, effects, duration)
    TriggerEvent('bk-usabledrugs:assumeDrug', type)
    
    duration = duration * 1000
    for k, effect in pairs(effects) do
        Citizen.CreateThread(function()
            BK.allEffects[effect](duration)
        end)
    end
end

RegisterNetEvent('bk-usabledrugs:drugEffects', drugEffects)